...
from .password_protect_routes import password_protect_bp




tools_bp.register_blueprint(password_protect_bp)
tools_bp.register_blueprint(excel_to_pdf_bp)
tools_bp.register_blueprint(pdf_to_word_bp)
tools_bp.register_blueprint(word_to_pdf_bp)
tools_bp.register_blueprint(powerpoint_to_pdf_bp)
tools_bp.register_blueprint(pdf_split_bp)
tools_bp.register_blueprint(pdf_merge_bp)  
tools_bp.register_blueprint(pdf_compress_bp)
tools_bp.register_blueprint(pdf_to_image_bp)
tools_bp.register_blueprint(image_to_pdf_bp)